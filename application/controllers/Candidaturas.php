...
class Candidaturas extends CI_Controller
{
    ...
    public function create()
    {
        ...
        } elseif (strlen($this -> uri -> segment(3)) > 0) {
    ...
    public function FormSituaFunc()
    {
        ...
        if ($this -> session -> candidato != $dados_candidatura[0] -> es_candidato) {
            ...
            exit();
        } elseif ($dados_candidatura[0] -> en_situacao_funcional != '1') {
    ...
    public function ListaAvaliacao($paginacao = 1)
    {
        ...
        if ($this -> session -> perfil == 'avaliador' && !isset($dados_form['filtro_status'])) {
    ...
    public function AvaliacaoEntrevista()
    {
        ...
        $dados['status'] = $this -> Candidaturas_model -> get_status();
        //var_dump($vaga);
        if (isset($candidatura[0]) && ($candidatura[0] -> es_status == '10' || $candidatura[0] -> es_status == '12')) {
    ...
    public function AvaliacaoEntrevistaEspecialista()
    {
        ...
        $dados['status'] = $this -> Candidaturas_model -> get_status();
        //var_dump($vaga);
        if (isset($candidatura[0]) && ($candidatura[0] -> es_status == '11' || $candidatura[0] -> es_status == '10')) {
    ...
    public function AgendamentoEntrevista()
    {
        ...
        else */if ($this -> session -> perfil == 'candidato' || $this -> session -> perfil == 'avaliador' || $this -> session -> perfil == 'sugesp') {
            $pagina['menu1']='Candidaturas';
            $pagina['menu2']='AgendamentoEntrevista';
            $pagina['url']='Candidaturas/AgendamentoEntrevista';
    ...
    public function mostra_questoes($questoes, $respostas, $opcoes, $erro, $edit=true, $avaliador='', $anexos_questao=array())
    {
        if (isset($questoes)) {
            ...
            foreach ($questoes as $row) {
                ...
                } elseif ($row -> in_tipo == 3 || $row -> in_tipo == 4) {
                    if ($edit) {
                        if ($row -> in_tipo == 3) {
