...
if (! defined('BASEPATH')) {
    exit('Não permitido o acesso direto ao script');
}
/**
 * @author Romão
 *
...
class Csvmodel
{
     ...
     * @return array
     */
    public function select($arquivo, $camposSelecionados=array())
    {
     ...
     * @return void
     */
    public function insert($arquivo, $post, $primaryKey=false)
    {
        $valores=@$this->getValores($arquivo);
        $campos=$this->campos;
        $read="";
     ...
     * @param array $post
     */
    public function escreveCache($post)
    {
        $campos=$this->campos;
        $read="";
     ...
     * @param string $arquivo
     */
    public function insertCache($arquivo)
    {
     ...
     *
     */
    public function printCache($nome)
    {
     ...
     * @return void
     */
    public function update($arquivo, $post, $chave)
    {
        $valores=$this->getValores($arquivo);
        $campos=$this->campos;
        $read="";
     ...
     * @return void
     */
    public function delete($arquivo, $camposSelecionados)
    {
        $valores=$this->getValores($arquivo);
        $campos=$this->campos;
        $chaves=array_keys($camposSelecionados);
     ...
     * @return buffer
     */
    public function fopen_mail($arquivo, $parametro)
    {
